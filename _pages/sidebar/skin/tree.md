...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar">
            <h2>Kaggle</h2>
            <ul>
                <li id="folder1">Machine Learning & Data Science Survey</li>
            </ul>
        </div>
    ...
    <script>
        ...
        function loadFolderContent(folder) {
            ...
            if (folder === 'folder3') {
                ...
                content.innerHTML = `
                    <h3><a href="https://github.com/potettang/Kaggle/tree/main/Kaggle%20Machine%20Learning%20%26%20Data%20Science%20Survey"><i class="fab fa-github"></i> Final Version Github Link</a></h3>
