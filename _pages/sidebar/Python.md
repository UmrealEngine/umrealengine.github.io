---
title: <img src="../images/ImgFile/python.png" width="400" height="400" referrerpolicy="no-referrer" alt="s1">
permalink: /Python/
layout: single
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar">
            <ul>
                <li id="folder4"><img src="../images/ImgFile/d8.png" style="height: 37px; width: auto; margin-top: -4px;" alt="C/C++/C# 이미지"> Numpy</li>
                <li id="folder3"><img src="../images/ImgFile/d8.png" style="height: 37px; width: auto; margin-top: -4px;" alt="C/C++/C# 이미지"> Pandas</li>
                <li id="folder2"><img src="../images/ImgFile/d8.png" style="height: 37px; width: auto; margin-top: -4px;" alt="C/C++/C# 이미지"> Algorithm</li>
                <li id="folder1"><img src="../images/ImgFile/d8.png" style="height: 37px; width: auto; margin-top: -4px;" alt="C/C++/C# 이미지"> Syntax</li>
            </ul>
        </div>
