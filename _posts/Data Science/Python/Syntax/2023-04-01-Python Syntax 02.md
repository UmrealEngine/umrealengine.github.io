...
<title>2. 연산자</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
...
<h1 id="2.-%EC%97%B0%EC%82%B0%EC%9E%90">2. &#50672;&#49328;&#51088;<a class="anchor-link" href="#2.-%EC%97%B0%EC%82%B0%EC%9E%90">&#182;</a></h1>
</div>
</div>
</div>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># 몫과 나머지를 함께 구하는 함수 : divmod()</span>

<span class="nb">divmod</span><span class="p">(</span><span class="mi">5</span><span class="p">,</span> <span class="mi">3</span><span class="p">)</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">div</span><span class="p">,</span> <span class="n">remainder</span> <span class="o">=</span> <span class="nb">divmod</span><span class="p">(</span><span class="mi">5</span><span class="p">,</span><span class="mi">3</span><span class="p">)</span>

<span class="nb">print</span><span class="p">(</span><span class="n">div</span><span class="p">,</span> <span class="n">remainder</span><span class="p">)</span> <span class="c1"># 이렇게도 가능</span>
</pre></div>
...
<span class="n">a</span> <span class="o">!=</span> <span class="n">b</span> <span class="c1">#같지 않다</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># 문자열 비교</span>

<span class="s2">&quot;Hi&quot;</span> <span class="o">==</span> <span class="s2">&quot;hi&quot;</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="s2">&quot;Hi&quot;</span> <span class="o">==</span> <span class="s2">&quot;Hi&quot;</span> 
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="mi">1</span> <span class="o">==</span> <span class="mf">1.0</span> <span class="c1"># 값 비교</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="mi">1</span> <span class="ow">is</span> <span class="mf">1.0</span> <span class="c1"># is, is not 객체 비교 , 값으로 볼때는 같지만 개체로 볼떄는 저장되는게 다르니깐 다르다 라고 생각</span>
</pre></div>
...
<pre>&lt;&gt;:1: SyntaxWarning: &#34;is&#34; with a literal. Did you mean &#34;==&#34;?
&lt;&gt;:1: SyntaxWarning: &#34;is&#34; with a literal. Did you mean &#34;==&#34;?
C:\Users\latex\AppData\Local\Temp\ipykernel_24820\607013919.py:1: SyntaxWarning: &#34;is&#34; with a literal. Did you mean &#34;==&#34;?
  1 is 1.0 # is, is not 객체 비교 , 값으로 볼때는 같지만 개체로 볼떄는 저장되는게 다르니깐 다르다 라고 생각
</pre>
</div>
</div>
<div class="jp-OutputArea-child jp-OutputArea-executeResult">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">id</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span> <span class="c1">#개체값 ex</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">id</span><span class="p">(</span><span class="mf">1.0</span><span class="p">)</span> <span class="c1">#개체값 ex</span>
</pre></div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
     <div class="CodeMirror cm-s-jupyter">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># 동전교환 프로그램</span>
<span class="c1">## 변수 선언 부분 ##</span>
<span class="n">money</span><span class="p">,</span> <span class="n">A500</span><span class="p">,</span> <span class="n">B100</span><span class="p">,</span> <span class="n">C50</span><span class="p">,</span> <span class="n">D10</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span>

<span class="c1">## 메인 코드 부분 ##</span>
<span class="n">money</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="nb">input</span><span class="p">(</span><span class="s2">&quot;거스름돈 뭐 줄까? : &quot;</span><span class="p">))</span>

<span class="n">c500</span> <span class="o">=</span> <span class="n">money</span> <span class="o">//</span> <span class="mi">500</span>
<span class="n">money</span> <span class="o">=</span> <span class="n">money</span> <span class="o">%</span> <span class="mi">500</span>

<span class="n">c100</span> <span class="o">=</span> <span class="n">money</span> <span class="o">//</span><span class="mi">100</span>
<span class="n">money</span> <span class="o">=</span> <span class="n">money</span> <span class="o">%</span> <span class="mi">100</span>

<span class="n">c50</span> <span class="o">=</span> <span class="n">money</span> <span class="o">//</span> <span class="mi">50</span>
<span class="n">money</span> <span class="o">=</span> <span class="n">money</span> <span class="o">%</span> <span class="mi">50</span>

<span class="n">c10</span> <span class="o">=</span> <span class="n">money</span> <span class="o">//</span><span class="mi">10</span>
<span class="n">money</span> <span class="o">=</span> <span class="n">money</span> <span class="o">%</span> <span class="mi">10</span>

<span class="n">c1</span> <span class="o">=</span> <span class="n">money</span> <span class="o">//</span><span class="mi">1</span>
<span class="n">money</span> <span class="o">=</span> <span class="n">money</span> <span class="o">%</span> <span class="mi">1</span>


<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;500원 ==&gt; </span><span class="si">%2d</span><span class="s2">개&quot;</span> <span class="o">%</span> <span class="n">c500</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;100원 ==&gt; </span><span class="si">%2d</span><span class="s2">개&quot;</span> <span class="o">%</span> <span class="n">c100</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot; 50원 ==&gt; </span><span class="si">%2d</span><span class="s2">개&quot;</span> <span class="o">%</span> <span class="n">c50</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot; 10원 ==&gt; </span><span class="si">%2d</span><span class="s2">개&quot;</span> <span class="o">%</span> <span class="n">c10</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;  1원 ==&gt; </span><span class="si">%2d</span><span class="s2">개&quot;</span> <span class="o">%</span> <span class="n">c1</span><span class="p">)</span>
</pre></div>
